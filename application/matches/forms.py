...
class MatchForm(FlaskForm):
    ...
    prob_1 = IntegerField("Home win probability (integer value 0-100 %)", [validators.NumberRange(min=0, max=100), validate_probabilities])
    prob_x = IntegerField("Draw probability (integer value 0-100 %)", [validators.NumberRange(min=0, max=100), validate_probabilities])
    prob_2 = IntegerField("Away win probability (integer value 0-100 %)", [validators.NumberRange(min=0, max=100), validate_probabilities])
